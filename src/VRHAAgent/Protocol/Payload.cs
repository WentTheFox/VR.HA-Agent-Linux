// Field names are part of the WebSocket protocol used by the Home Assistant integration, so they stay lowerCamelCase.
// ReSharper disable InconsistentNaming

namespace VRHAAgent.Protocol;
...
public class Payload
{
    ...
    public string basicTitle = "Home Assistant Agent for VR";
    public string basicMessage = "";

    // Custom notification
    public CustomProperties customProperties = new();
    ...
    public class TextArea
    {
        ...
        public int verticalAlignment = 0; // 0: Top, 1: Center, 2: Bottom
    }
}
